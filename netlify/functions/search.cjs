...
exports.handler = async (event, context) => {
    ...
    try {
        // 1. GỌI QUA CLOUDFLARE WORKER (PROXY TRUNG GIAN DÙNG ĐỂ FAKE IP)
        const encodedWord = encodeURIComponent(word);
        const cloudflareUrl = `https://hanzii-proxy.tuanphan1112-working.workers.dev/?word=${encodedWord}`;
        ...
        // Fallback data cho từ 'kết hôn' nếu API lỗi
        if (word === 'kết hôn' || word === '结婚') {
            const fallback = {
                "total": 1,
                "found": true,
                "result": [{
                    ...
                    "pinyin": "jiéhūn",
                    "cn_vi": "kết hôn",
                    "content": [{ "means": [{ "mean": "cưới; kết hôn" }] }]
                }]
            };
            return {
                statusCode: 200,
